...
sprite_change_offset("dash", 11, 27);
sprite_change_offset("dashstart", 11, 27);
sprite_change_offset("dashstop", 11, 27);
sprite_change_offset("dashturn", 11, 26);

sprite_change_offset("jumpstart", 12, 24);
...
sprite_change_offset("fstrong", 14, 27, true);
sprite_change_offset("dstrong", 11, 29, true);
sprite_change_offset("ustrong", 11, 41, true);
...
sprite_change_offset("fspecial", 27, 41, true);
...
sprite_change_offset("intro", 110, 106);
...
sprite_change_offset("blaster_top_shoot_up", 17, 22);
sprite_change_offset("blaster_top_shoot_down", 19, 25);

sprite_change_offset("sniper_scope", 15, 7);
sprite_change_offset("sniper_arm", 0, 0);
