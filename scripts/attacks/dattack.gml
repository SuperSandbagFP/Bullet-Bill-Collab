...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_zetter_fireball_fire"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_zetter_fireball_fire"));
...
set_hitbox_value(AT_DATTACK, 3, HG_HIT_SFX, asset_get("sfx_zetter_fireball_fire"));
