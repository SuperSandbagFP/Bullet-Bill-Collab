...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 39);
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, .3);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("hitfxbump_smb3"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("sfx_ell_explosion_medium"));
