...
set_window_value(AT_UAIR, 4, AG_WINDOW_SFX, asset_get("mfx_ring_bell"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("kick_smb3"));
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 53);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("meow_mp"));
