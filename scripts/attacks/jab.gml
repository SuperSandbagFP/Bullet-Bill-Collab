...
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 41);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("kick_smb3"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("kick_smb3"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("kick_smw"));
...
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 63);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 38);
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("kick_smw"));
